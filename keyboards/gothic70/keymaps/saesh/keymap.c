...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______, _______,           IJ_CMD, \
    _______, _______, _______, _______, _______, _______,          _______, _______, _______, _______, _______, _______, _______,  KC_DEL,          _______, \
    _______, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______,          KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, _______, _______,          _______,          _______, \
  ...
  [2] = LAYOUT(
    KC_SLEP, KC_SECRET_1, KC_SECRET_2, KC_SECRET_3, KC_SECRET_4, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,         KC_MAKE, \
