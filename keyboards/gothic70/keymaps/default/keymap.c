...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT(
    _______,   KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,  KC_F12, _______, _______,          LCTL(LSFT(KC_A)), \
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,                   LSFT(KC_F10), \
    _______, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, _______, KC_LEFT, KC_DOWN, KC_UP, KC_RGHT, _______, _______, _______,                               LCTL(KC_R), \
  ...
  [2] = LAYOUT(
    ...
    _______, LAG_SWAP, LAG_NORM, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MPLY,                   KC_SLEP, \
