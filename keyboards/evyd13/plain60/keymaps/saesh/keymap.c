...
[_FN2] = LAYOUT_60_hhkb(
  _______, KC_SEC1, KC_SEC2, KC_SEC3, KC_SEC4, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, \
  ...
  _______,          _______, _______, KC_CALC, _______, _______, _______, KC_MAKE, _______, _______, _______, _______, _______, \
