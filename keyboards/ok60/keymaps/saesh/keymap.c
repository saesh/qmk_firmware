...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  */
  [BASE] = LAYOUT_60_ansi_split_bksp_rshift(
      ...
      KC_CAPS,  KC_LGUI, KC_LALT,                        KC_SPC,                                KC_RALT,           KC_RGUI,         XXXXXXX, XXXXXXX
  ),
  ...
  */
  [SPECIAL] = LAYOUT_60_ansi_split_bksp_rshift(
      KC_SLEP,  _______,  _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, KC_MAKE,
