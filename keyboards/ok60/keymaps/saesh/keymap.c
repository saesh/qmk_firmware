...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  * |-----------------------------------------------------------------------------------------+
  * | FN   | LAlt | LGUI |                FN/Space                |Alt/Ho| PgDn | PgUp |  End |
  * `-----------------------------------------------------------------------------------------'
  */
  [BASE] = LAYOUT_60_ansi_split_bksp_rshift(
      ...
      MO(FN),   KC_LALT, KC_LGUI,                LT(FN, KC_SPC),                                HOME_ALT,          KC_PGDN,           KC_PGUP, KC_END
  ),
  ...
  */
  [FN] = LAYOUT_60_ansi_split_bksp_rshift(
      ...
      _______, _______, _______, _______, _______, _______, KC_LEFT, KC_DOWN,   KC_UP, KC_RIGHT,_______, _______, MO(SPECIAL),
