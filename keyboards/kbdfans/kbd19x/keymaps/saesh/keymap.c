...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [0] = LAYOUT_all( /* Base */
    ...
    KC_LCTL, DE_A,    DE_S,    DE_D,    DE_F,    DE_G,    DE_H,    DE_J,    DE_K,    DE_L,    DE_ODIA, DE_ADIA,                    KC_ENT,          KC_P4,   KC_P5,   KC_P6,   _______, \
  ...
  [1] = LAYOUT_all( /* Func */
    _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______, _______, _______, _______,  _______,                  KC_SECRET_1, KC_SECRET_2, _______, _______, \
    ...
    _______, _______, _______, _______,   RESET, _______, _______, _______, _______, KC_MAIL, _______, _______, _______,  _______,                  _______, _______, _______, _______, \
