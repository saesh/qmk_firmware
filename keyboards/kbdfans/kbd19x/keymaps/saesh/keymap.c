...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [1] = LAYOUT_all( /* Func */
    _______, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, _______,   _______, _______, _______,  _______,                  KC_MAIL, _______, _______, _______, \
    ...
    _______, _______, _______, _______,   RESET, _______, _______, _______, _______, LCA(KC_O), _______, _______, _______,  _______,                  _______, _______, _______, _______, \
